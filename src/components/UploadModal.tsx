...
export default function UploadModal({
  ...
  return (
    ...
    >
      <ModalHeader>
        <div className={css({ fontFamily: "UberMove", fontWeight: 700 })}>
          Upload Data
        </div>
      </ModalHeader>
      ...
      <ModalBody>
        ...
        >
          Upload your team productivity workbook (.xlsx, .xls, or .csv) to
        ...
        >
          ...
          <div className={css({ fontSize: "34px", marginBottom: "8px" })}>
            📊
          </div>
        ...
        {uploaded && (
          <div className={css({ marginTop: "16px" })}>
            ...
            >
              ✅ Workbook processed successfully! Dashboard data has been
              refreshed.
            </Notification>
          </div>
        )}
        ...
        <ModalButton
          ...
          overrides={{
            BaseButton: {
              style: {
                backgroundColor:
                  !file || uploading || uploaded ? "#E8E8E8" : "#000",
